                        ...
                        <div class="card-body">
                            <div class="tab-content" id="custom-tabs-one-tabContent">
                                ...
                                <div class="tab-pane fade" id="custom-tabs-one-social" role="tabpanel" aria-labelledby="custom-tabs-one-social-tab">
                                    <div class="form-group">
                                        <label >GitHub</label>
                                        <input type="text" name="facebook"  value="{{$data->github}}" class="form-control"   >
                                    </div>
                                    <div class="form-group">
                                ...
                                </div><div class="tab-pane fade" id="custom-tabs-one-references" role="tabpanel" aria-labelledby="custom-tabs-one-references-tab">
                                    <div class="form-group">
